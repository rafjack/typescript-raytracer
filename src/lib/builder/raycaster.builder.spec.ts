...
describe('raycaster.builder.spec', () => {
  ...
  it('Creating a default world', () => {
    ...
    sphereB.setMatrix(RayCasterBuilder.getScalingMatrix(0.5, 0.5, 0.5));
  ...
  it('The default transformation of the test shape', () => {
    ...
    expect(s.getMatrix()).toEqual(RayCasterBuilder.createIdentityMatrix(4));
  });
  ...
  it('Assign a transformation', () => {
    ...
    s.setMatrix(RayCasterBuilder.getTranslationMatrix(2, 3, 4));

    // THEN it should equal
    expect(s.getMatrix()).toEqual(
  ...
  it('Intersecting a scaled shape with a ray', () => {
    ...
    testShape.setMatrix(RayCasterBuilder.getScalingMatrix(2, 2, 2));
  ...
  it('Intersecting a translated shape with a ray', () => {
    ...
    testShape.setMatrix(RayCasterBuilder.getTranslationMatrix(5, 0, 0));
    testShape.intersect(ray);
  ...
  it('Computing the normal on a translated shape', () => {
    ...
    // WHEN
    testShape.setMatrix(RayCasterBuilder.getTranslationMatrix(0, 1, 0));
    const n: Vector = testShape.normal_at(new Point(0, 1.70711, -0.70711));
  ...
  it('Computing the normal on a transformed shape', () => {
    ...
    testShape.setMatrix(m);
    const n: Vector = testShape.normal_at(
